...
- Add SonarQube via SonarCloud (https://sonarcloud.io/dashboard?id=ammarfarooqi_takenote)
...
- Add code for integrating GitHub sync (https://github.com/ammarfarooqi/takenote/pull/389)

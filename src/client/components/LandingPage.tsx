    ...
    <section className="landing-page">
          ...
          <div className="features">
            ...
            <ul>
              ...
              <li>
                ...
                beautiful <a href="https://ammarfarooqi.github.io/new-moon/">New Moon theme</a>)
              </li>
              <li>
      ...
      <footer className="footer">
        <div className="container-small">
          ...
          <nav>
            <a
              href="https://github.com/ammarfarooqi/takenote"
              target="_blank"
            ...
            <a
              href="https://github.com/ammarfarooqi/takenote/issues"
              target="_blank"
              rel="noopener noreferrer"
            >
              Issues
            ...
            <a
              href="https://github.com/ammarfarooqi/takenote/graphs/contributors"
              target="_blank"
              rel="noopener noreferrer"
            >
              Contributors
